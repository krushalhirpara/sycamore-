        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mt-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4">
              {[
                { icon: <Mail size={18} className="text-[#131A22]" />, label: 'Email Us', value: 'contact@sycamoreeastspn.com', href: 'mailto:contact@sycamoreeastspn.com' },
                { icon: <MapPin size={18} className="text-[#131A22]" />, label: 'Headquarters', value: 'Ahmedabad, Gujarat', href: undefined },
              ].map((item, i) => (
              ...
              {status === 'error' && (
                <div className="mb-6 flex items-start gap-3 p-4 rounded-2xl bg-red-100 border border-[#E5E7EB] text-red-800">
                  ...
                  <div>
                    ...
                    <p className="text-xs mt-1 font-medium">Something went wrong. Please try again or email us directly at contact@sycamoreeastspn.com</p>
                  </div>
                </div>
              )}
