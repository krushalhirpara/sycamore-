    ...
    <section className="bg-[#F7F7F7] py-20 relative border-t border-[#E5E7EB]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-[#131A22]">
            ...
            <Card variant="glow-amazon" className="h-full flex flex-col justify-between" hoverEffect>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-[#FFF4E5] border border-[#FF9900] flex items-center justify-center text-[#FF9900]">
                    <ShoppingBag size={20} />
                  </div>
                  <h3 className="font-heading font-extrabold text-xl text-[#131A22]">
                    The Amazon Playbook
                  </h3>
                </div>
                ...
                <ul className="space-y-2 text-xs text-[#131A22] font-semibold pl-0 list-none">
              ...
              <div className="text-[#FF9900] text-xs font-black font-heading uppercase tracking-wider mt-6 flex items-center gap-1">
